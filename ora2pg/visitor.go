...
// func (v *Ora2PgVisitor) VisitTerminal(node antlr.TerminalNode) interface{} {
// 	return node.GetText()
// }

// func (v *Ora2PgVisitor) VisitErrorNode(node antlr.ErrorNode) interface{} {
// 	return nil
// }
...
func (o *Ora2PgVisitor) VisitNon_reserved_keywords_pre12c(ctx *parser.Non_reserved_keywords_pre12cContext) interface{} {
	...
	return o.VisitChildren(ctx)
}

func (o *Ora2PgVisitor) VisitCreate_table(ctx *parser.Create_tableContext) interface{} {
	if ctx.TABLE() != nil {
...
func (o *Ora2PgVisitor) VisitQuery_block(ctx *parser.Query_blockContext) interface{} {
